...
All public repositories under the [Jawafdehi](https://github.com/Jawafdehi) GitHub organization are licensed under the **Hippocratic License Version 3.0 (HL3)**, an [Ethical Source](https://ethicalsource.dev) license.
...
The full license text is in the [LICENSE](./LICENSE) file at the root of each repository.
...
All public Jawafdehi repositories use HL3:

| Repository | License |
|-----------|---------|
| [jawafdehi-meta](https://github.com/Jawafdehi/jawafdehi-meta) | [HL3](./LICENSE) |
| [JawafdehiAPI](https://github.com/Jawafdehi/JawafdehiAPI) | HL3 |
| [Jawafdehi](https://github.com/Jawafdehi/Jawafdehi) | HL3 |
| [NepalEntityService](https://github.com/Jawafdehi/NepalEntityService) | HL3 |
| [NepalEntityService-Tundikhel](https://github.com/Jawafdehi/NepalEntityService-Tundikhel) | HL3 |
| [NepalEntityService-database](https://github.com/Jawafdehi/NepalEntityService-database) | HL3 |
| [NepalEntityService-assets](https://github.com/Jawafdehi/NepalEntityService-assets) | HL3 |
| [ngm](https://github.com/Jawafdehi/ngm) | HL3 |
| [ngm-frontend](https://github.com/Jawafdehi/ngm-frontend) | HL3 |
| [jawafdehi-mcp](https://github.com/Jawafdehi/jawafdehi-mcp) | HL3 |
| [jawafdehi-agents](https://github.com/Jawafdehi/jawafdehi-agents) | HL3 |
| [jawafdehi-agentspan](https://github.com/Jawafdehi/jawafdehi-agentspan) | HL3 |
| [likhit](https://github.com/Jawafdehi/likhit) | HL3 |
| [newnepal-website](https://github.com/Jawafdehi/newnepal-website) | HL3 |
| [GCP-deployment](https://github.com/Jawafdehi/GCP-deployment) | HL3 |

The private `org-admin-panel` repository is excluded from the public license requirement.
