  ...
  ({ className, ...props }, ref) => (
    <Card
      ...
      className={cn(
        ...
        "after:pointer-events-none after:absolute after:-bottom-28 after:-left-28 after:z-0 after:h-80 after:w-80 after:rounded-full after:bg-[hsl(209_61%_84%)] after:opacity-0 after:blur-[80px] after:transition-opacity after:duration-300 hover:after:opacity-45",
        "[&>*]:relative [&>*]:z-10",
        className,
      )}
      {...props}
