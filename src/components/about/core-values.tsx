...
export function CoreValues() {
  ...
  return (
    <section id="values" className="border-t border-border/50 bg-muted/20 pt-10 pb-12 md:pt-12 md:pb-14">
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {coreValues.map(({ key, icon: Icon }) => (
            <div key={key} className="mx-auto flex max-w-[15rem] flex-col items-center text-center">
              <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-full border border-primary/20 bg-primary/[0.07] text-primary">
                <Icon aria-hidden="true" className="h-10 w-10" strokeWidth={1.85} />
              </div>
