    ...
    <article className="border-b border-border/70 py-3 last:border-b-0">
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {(source?.source_type !== 'MEDIA_NEWS' || !source?.description || source.description.trim() === '.' || !source.description.trim()) && evidenceDescription && evidenceDescription.trim() !== '.' && evidenceDescription.trim() && (
